...
public class UserService {
    ...
    public void signUp(NewUserRequest newUserRequest)throws InvalidUserInputException, ResourcePersistenceException {
        ...
        isUsernameValid(newUserRequest.getUsername());
        ...
        newMsg.setContent("Welcome to TU$E! A little something has been added to your account to get you started. " +
                "Check your balance (dashboard -> account -> balance). Happy Trading!");
    ...
    public void isUsernameValid(String username){
        if (userRepo.fetchUsername(username).isPresent())
    ...
    @Transactional
    public void update(UpdateUserRequest updateRequest, User currentUser) throws InvalidUserInputException, ResourcePersistenceException{
        ...
        if(notNullOrEmpty.test(updateRequest.getUsername())) {
            isUsernameValid(updateRequest.getUsername());
